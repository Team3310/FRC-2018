...
public class Angle2D {
	 ...
	 * points.
	 */
	public static double horizontalAngle(AbstractLine2D object) {
	 ...
	 */
	public static double angle(AbstractLine2D obj1, AbstractLine2D obj2) {
	...
	public static boolean equals(double angle1, double angle2) {
		...
		angle2 = formatAngle(angle2);
		double diff = formatAngle(angle1 - angle2);
		if (diff < EqualUtils.ACCURACY)
			return true;
		if (Math.abs(diff - Math.PI * 2) < EqualUtils.ACCURACY)
			return true;
		return false;
	}
