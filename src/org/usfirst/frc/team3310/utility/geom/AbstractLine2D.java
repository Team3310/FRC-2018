...
public abstract class AbstractLine2D {
    ...
    public static Point2D getIntersection(AbstractLine2D line1,
		...
		if (Math.abs(denom) < EqualUtils.ACCURACY)
			return null;
	...
	public static boolean isColinear(AbstractLine2D line1, AbstractLine2D line2) {
		...
		if (Math.abs(line1.dx * line2.dy - line1.dy * line2.dx) > EqualUtils.ACCURACY)
			return false;
		...
		return (Math.abs((line2.y0 - line1.y0) * line2.dx
				...
				/ Math.hypot(line2.dx, line2.dy) < EqualUtils.ACCURACY);
	}
	...
	public static boolean isParallel(AbstractLine2D line1, AbstractLine2D line2) {
		return (Math.abs(line1.dx * line2.dy - line1.dy * line2.dx) < EqualUtils.ACCURACY);
	}
	...
	protected boolean supportContains(double x, double y) {
		...
		if (denom < EqualUtils.ACCURACY)
			throw new DegeneratedLine2DException(this);
		return (Math.abs((x - x0) * dy - (y - y0) * dx) / denom < EqualUtils.ACCURACY);
	}
    /**
   ...
   // ===================================================================
	...
	public double position(Point2D point) {
		...
		double eps = Math.hypot(dx, dy) * EqualUtils.ACCURACY;
   ...
   public abstract AbstractLine2D transform(AffineTransform2D transform);
    ...
    public boolean isEmpty() {
		return Math.hypot(dx, dy) < EqualUtils.ACCURACY;
    }
