...
public class Vector2D {
	...
	public static boolean isColinear(Vector2D v1, Vector2D v2) {
		v1 = v1.normalize();
		v2 = v2.normalize();
		return Math.abs(v1.x * v2.y - v1.y * v2.x) < EqualUtils.ACCURACY;
	}
    ...
    public static boolean isOrthogonal(Vector2D v1, Vector2D v2) {
        v1 = v1.normalize();
		v2 = v2.normalize();
		return Math.abs(v1.x * v2.x + v1.y * v2.y) < EqualUtils.ACCURACY;
	}
     ...
     * Consider creating a new Vector uMath.sing static factory.
     */
     ...
     */
	public boolean almostEquals(Vector2D obj, double eps) {
		if (this == obj)
			return true;
