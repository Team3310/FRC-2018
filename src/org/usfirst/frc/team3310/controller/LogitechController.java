 ...
 * @author frc1675
 */
public class LogitechController implements IHandController
{
...
//	public static final int TOP_BOTTOM_DPAD_AXIS = 7;    // Can't use this axis... the Driver Station only transmits 6 axes.
	...
	public LogitechController(int portNumber){
	...
	public boolean getLeftBumperButton(){
		return stick.getRawButton(LB_BUTTON);
	}

	public boolean getRightBumperButton(){
		return stick.getRawButton(RB_BUTTON);
	}
	...
	public double getLeftTriggerAxis(){
		return getAxisWithDeadZoneCheck(stick.getRawAxis(LT_BUTTON)); 
	}

	public double getRightTriggerAxis(){
		return getAxisWithDeadZoneCheck(stick.getRawAxis(RT_BUTTON)); 
	}
