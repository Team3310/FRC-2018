...
import org.usfirst.frc.team3310.paths.auton.ScaleRightToSwitchRightV2;
...
public class LeftStartToScaleLeft1SwitchRight1V2 extends CommandGroup {
    ...
    public LeftStartToScaleLeft1SwitchRight1V2() {
    	...
    	addSequential(new StartToScale1Switch1(new LeftStartToScaleLeftV2(), new ScaleLeftToSwitchLeft(), new SwitchLeftToScaleRightV2(), new ScaleRightToSwitchRightV2()));
