 ...
 *
 */
public class CenterStartToSwitch1PickupLastCube extends CommandGroup {

    public CenterStartToSwitch1PickupLastCube(PathContainer startToScalePath, PathContainer scaleToSwitchPath) {
