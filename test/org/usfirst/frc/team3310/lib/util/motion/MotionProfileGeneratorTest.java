...
import static org.usfirst.frc.team3310.lib.util.TestUtil.epsilonEqualTo;

import org.junit.Test;
import org.usfirst.frc.team3310.utility.motion.MotionProfile;
import org.usfirst.frc.team3310.utility.motion.MotionProfileConstraints;
import org.usfirst.frc.team3310.utility.motion.MotionProfileGenerator;
...
import org.usfirst.frc.team3310.utility.motion.MotionUtil;
...
public class MotionProfileGeneratorTest {
    ...
    protected static void validateProfile(MotionProfileConstraints constraints, MotionProfileGoal goal,
        ...
        assertThat(profile.startState().t(), epsilonEqualTo(start.t(), MotionUtil.kEpsilon));
        assertThat(profile.startState().pos(), epsilonEqualTo(start.pos(), MotionUtil.kEpsilon));
        assertThat(profile.startState().vel(), epsilonEqualTo(
                Math.signum(start.vel()) * Math.min(Math.abs(start.vel()), constraints.max_abs_vel()), MotionUtil.kEpsilon));
    ...
    protected static void testProfile(MotionProfileConstraints constraints, MotionProfileGoal goal, MotionState start,
        ...
        assertThat(positive_profile.toString(), positive_profile.duration(),
                epsilonEqualTo(expected_duration, MotionUtil.kEpsilon));
        assertThat(positive_profile.toString(), positive_profile.length(), epsilonEqualTo(expected_length, MotionUtil.kEpsilon));
        ...
        assertThat(negative_profile.toString(), negative_profile.duration(),
                epsilonEqualTo(expected_duration, MotionUtil.kEpsilon));
        assertThat(negative_profile.toString(), negative_profile.length(), epsilonEqualTo(expected_length, MotionUtil.kEpsilon));
